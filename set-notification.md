...
Notification mode:
  ...
  2. Smart   — different sound per scenario (Python required, script auto-created)
               ...
               idle_prompt        → Funk.aiff  + say [random StarCraft quote]

Enter [1/2]:
```

- Choose `1` → proceed to Q3a (configure phrase) then Q4a (configure sound)
- Choose `2` → script will be auto-written in Step 3, skip Q3a/Q4a, jump to Q5
...
STARCRAFT_IDLE = [
    ...
    "I'm locked in here with a bunch of perverts!",
    "What, you ran out of Marines?",
    "You want a piece of me, boy?",
    "How do I get out of this chicken-shit outfit?",
    "I come in peace... usually.",
    "I'm about to drop the hammer and dispense some justice!",
    "I love the smell of singed Zerg in the morning.",
    "Abandon ship! Dammit, can't find the buttons!",
    "I see dead people.",
    "Nuclear launch detected.",
    "The doctor is in.",
    "I've already diagnosed your condition... INFECTED!",
]
...
| `idle_prompt` | Waiting for text input | Funk.aiff | random StarCraft quote (13 lines) |
